...
The recordings used in this study are freely available online from this URL: [dansklyd.statsbiblioteket.dk/samling/dialektsamlingen](https://dansklyd.statsbiblioteket.dk/samling/dialektsamlingen/). Other analysis data, fitted model objects, and code, including a version of this paper with embedded R code demonstrating all analytical steps, will be shared in an open repository if the paper is accepted. These will be made available to reviewers upon request.
